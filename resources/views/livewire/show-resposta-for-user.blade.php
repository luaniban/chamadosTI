<div class="min-h-screen p-6 bg-slate-50">
    <div class="max-w-5xl mx-auto shadow-sm bg-white/90 backdrop-blur rounded-2xl ring-1 ring-slate-200">
        ...
        <div class="divide-y divide-slate-200">
            ...
            <div class="flex items-center justify-between p-6 transition hover:bg-slate-50" wire:click="dispatchShowResponse({{ $chamado->id }})">
                <div>
            ...
            <div class="flex items-center justify-between p-6 transition hover:bg-slate-50">
                <div>
                    <h2 class="text-lg font-semibold text-slate-700">Computador da recepção não liga</h2>
                    <p class="text-sm text-slate-500">Categoria: Hardware • Urgência: Média</p>
                </div>
                <span class="px-3 py-1 text-xs font-medium text-yellow-700 bg-yellow-100 rounded-full">
                    Aguardando Resposta
                </span>
            ...
            <div class="flex items-center justify-between p-6 transition hover:bg-slate-50">
                <div>
                    <h2 class="text-lg font-semibold text-slate-700">Solicitação de instalação de impressora</h2>
                    <p class="text-sm text-slate-500">Categoria: Impressão & Digitalização • Urgência: Baixa</p>
                </div>
                <span class="px-3 py-1 text-xs font-medium text-yellow-700 bg-yellow-100 rounded-full">
                    Aguardando Resposta
                </span>
